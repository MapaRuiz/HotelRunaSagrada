    ...
    public void newUserRegisterUseCase() throws InterruptedException {
        ...
        WebElement loginLink = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("/html/body/app-root/app-landing/app-primera/section/div/div/div[2]/button")));
        loginLink.click();
        ...
        WebElement primerTipoHabitacion = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath(
                                "/html/body/app-root/app-hotel-detail/div/app-hotel-rooms/section/div/div/div/a[1]/div/div/span[2]")));
        ((JavascriptExecutor) driver)
                .executeScript("arguments[0].scrollIntoView({block: 'center'}); arguments[0].click();",
                        primerTipoHabitacion);
        ...
        jes.executeScript("arguments[0].value='" + checkIn + "'; arguments[0].dispatchEvent(new Event('input'));",
                checkInInput);
        jes.executeScript("arguments[0].value='" + checkOut + "'; arguments[0].dispatchEvent(new Event('input'));",
                checkOutInput);
        ...
        WebElement continuePaymentBtn = wait.until(driver -> {
            WebElement btn = driver
                    .findElement(By.xpath("/html/body/app-root/app-reservation-summary/div/div/div[3]/div[1]/button"));
        ...
        WebElement addPaymentBtn = wait.until(
                ExpectedConditions.presenceOfElementLocated(
                        By.xpath("/html/body/app-root/app-payment/div/div/div[3]/div[1]/div[1]/div/button")));
        ...
        waitOverlay.until(
                ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loading-overlay, div.spinner")));
        ...
        WebElement firstRoomAssigned = reservationSection.findElement(
                By.xpath(
                        ".//div[@class='section-card']//div[@class='detail-row'][span[text()='Habitación:']]/span[@class='detail-value']"));
        ...
        List<WebElement> availableRooms = wait.until(
                d -> d.findElements(
                        By.xpath("/html/body/app-root/app-hotel-detail/div/app-hotel-rooms/section/div/div/div/a")));
        ...
        ((JavascriptExecutor) driver)
                .executeScript("arguments[0].scrollIntoView({block: 'center'}); arguments[0].click();", selectedRoom);

        WebElement checkInInput2 = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector("section.reserve-card form #checkIn")));
        WebElement checkOutInput2 = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector("section.reserve-card form #checkOut")));

        jes.executeScript("arguments[0].value='" + secondCheckIn + "'; arguments[0].dispatchEvent(new Event('input'));",
                checkInInput2);
        jes.executeScript(
                "arguments[0].value='" + secondCheckOut + "'; arguments[0].dispatchEvent(new Event('input'));",
                checkOutInput2);
        ...
        ((JavascriptExecutor) driver).executeScript(
                "arguments[0].scrollIntoView({block: 'center'}); arguments[0].click();", continuePaymentBtn2);
        ...
        assertTrue(!secondRoomNumber.equals(firstRoomNumber),
                "La segunda habitación no debe ser la misma que la primera.");
